...
public class Main {
    ...
    private static Bank bank = new Bank("Alisha National Bank");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n  Thank you for using Alisha National Bank. Goodbye!");
        scanner.close();
    }
    ...
    private static void printWelcomeBanner() {
        System.out.println("\n" + "=".repeat(55));
        System.out.println("       ALISHA NATIONAL BANK - MANAGEMENT SYSTEM       ");
